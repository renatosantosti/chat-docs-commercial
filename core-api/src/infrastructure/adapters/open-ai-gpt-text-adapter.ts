...
export default class OpenAIGptTextAdapter implements IGptTextAdapter {
    ...
    constructor(openAiKey: string, chatModel: OpenAIChatEnumModels= OpenAIChatEnumModels.GPT4Turbo, chatTemperature: number = 0.7, embeddingModel: OpenAIEmbeddingEnumModels = OpenAIEmbeddingEnumModels.ADA002, maxTokens:number = 500){
  ...
  async getResponse(messages: ChatCompletatioDto[]): Promise<string | undefined>{
