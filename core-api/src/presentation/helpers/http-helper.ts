...
export const badRequestHttpError = (error: Error): IBaseHttpResponse<Error> => ({
  description: "Bad Request",
  statusCode: HttpStatusCode.BAD_REQUEST,
  data: { message: error.message, name: error.name, stack:error?.stack }
});

export const conflictRequestHttpError = (error: Error): IBaseHttpResponse<Error> => ({
...
export const invalidParamHttpError = (error: Error): IBaseHttpResponse<Error> => ({
  description: "Invalid Param",
  statusCode: HttpStatusCode.BAD_REQUEST,
  data: { message: error.message, name: error.name, stack:error?.stack  }
});

export const missingParamHttpError = (error: Error): IBaseHttpResponse<Error> => ({
...
export const unauthorizedHttpError = (error: UnauthorizedError): IBaseHttpResponse<UnauthorizedError> => ({
  description: "Unauthorized Access",
  statusCode: HttpStatusCode.UNAUTHORIZED,
  data: { message: error.message, name: error.name, stack:error?.stack  }
});

export const internalHttpError = (error: Error): IBaseHttpResponse<InternalError> => {
  return ({
