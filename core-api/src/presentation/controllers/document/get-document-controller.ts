...
import GetDocumentRequest from "@/application/interfaces/use-cases/document/get/get-document-request";
import GetDocumentResponse from "@/application/interfaces/use-cases/document/get/get-document-response";
...
@injectable()
export default class GetDocumentController
  implements IBaseController<GetDocumentRequest, GetDocumentResponse>
{
  public currentUser?: AuthUserDto;
  constructor(
    @inject("IGetDocumentUseCase") readonly useCase: IGetDocumentUseCase,
  ) {}

  public async handler(
    currentUser: AuthUserDto,
    request: GetDocumentRequest,
  ): Promise<IBaseHttpResponse<GetDocumentResponse | Error>> {
    ...
    try {
      ...
      const response: GetDocumentResponse | Error = await this.useCase.handler(
        this.currentUser,
        request,
      );
      ...
      console.error("Occured an error to get a document", {
        error: error.message,
        name: error.name,
      });
      let responseError: IBaseHttpResponse<Error>;
