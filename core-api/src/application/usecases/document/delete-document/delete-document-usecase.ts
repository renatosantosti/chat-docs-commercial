...
export default class DeleteDocumentUseCase implements IDeleteDocumentUseCase {
   ...
   */
  constructor(readonly timeProvider: ITimeAdapter, readonly repository: IDocumentRepository, readonly mapper: IBaseMapper<Document, DocumentDto>) { }
   ...
   */
  async handler(currentUser: AuthUserDto, request: DeleteDocumentRequest): Promise<DeleteDocumentResponse | Error> {
