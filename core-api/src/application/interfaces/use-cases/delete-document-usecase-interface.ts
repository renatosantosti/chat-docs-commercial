 ...
 */
export interface IDeleteDocumentUseCase extends IBaseUseCaseRequestHandler<DeleteDocumentRequest, DeleteDocumentResponse> {
  /**
   ...
   */
  handler(currentUser: AuthUserDto, request: DeleteDocumentRequest): Promise<DeleteDocumentResponse | Error>;
}
