...
import CreateDocumentRequest from "../../usecases/document/create-document/create-document-request";
import { CreateDocumentResponse } from "../../usecases/document/create-document/create-document-response";
 ...
 */
export interface ICreateDocumentUseCase extends IBaseUseCaseRequestHandler<CreateDocumentRequest, CreateDocumentResponse> {
  /**
   ...
   */
  handler(currentUser: AuthUserDto, request: CreateDocumentRequest): Promise<CreateDocumentResponse | Error>;
}
