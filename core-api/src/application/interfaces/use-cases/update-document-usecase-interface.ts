 ...
 */
export interface IUpdateDocumentUseCase extends IBaseUseCaseRequestHandler<UpdateDocumentRequest, UpdateDocumentResponse> {
  /**
   ...
   */
  handler(currentUser: AuthUserDto, request: UpdateDocumentRequest): Promise<UpdateDocumentResponse | Error>;
}
