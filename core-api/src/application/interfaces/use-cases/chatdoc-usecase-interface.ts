 ...
 */
export interface IChatDocUseCase extends IBaseUseCaseRequestHandler<ChatDocRequest, ChatDocResponse> {
  /**
   ...
   */
  handler(currentUser: AuthUserDto, request: ChatDocRequest): Promise<ChatDocResponse | Error>;
}
